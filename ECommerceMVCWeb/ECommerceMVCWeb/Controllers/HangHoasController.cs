...
namespace ECommerceMVCWeb.Controllers
{
    ...
    {
        private readonly Hshop2025Context _context;

        public HangHoasController(Hshop2025Context context)
        {
            _context = context;
        }
        ...
        {
            var hshop2025Context = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await hshop2025Context.ToListAsync());
        }
