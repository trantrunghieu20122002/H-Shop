...
namespace ECommerceMVCWeb.Data;

public partial class Hshop2025Context : DbContext
{
    public Hshop2025Context()
    {
    }

    public Hshop2025Context(DbContextOptions<Hshop2025Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=TranHieu;Initial Catalog=Hshop2025;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
